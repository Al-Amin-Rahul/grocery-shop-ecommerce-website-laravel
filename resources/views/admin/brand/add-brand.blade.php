    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form class="offset-3 col-sm-6" action="{{route('brand.store')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="brand_description" rows="4" style="resize: vertical"></textarea>
                        </div>
                    </div>
